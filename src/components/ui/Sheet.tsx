  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        class={cn(
          "fixed inset-y-0 right-0 z-50 flex h-full w-3/4 max-w-lg flex-col gap-4 border-l bg-background p-6 shadow-lg duration-200 data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:slide-out-to-right data-[expanded]:slide-in-from-right sm:max-w-xl",
          local.class,
        )}
        {...others}
      >
