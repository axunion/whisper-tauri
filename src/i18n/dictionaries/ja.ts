...
export const ja: Dictionary = {
  ...
  textProcessing: {
    ...
    settingUp: "セットアップ中...",
    extractKeywords: "キーワード",
    extractActionItems: "アクションアイテム",
    keywordsLabel: "キーワード",
    actionItemsLabel: "アクションアイテム",
    noActionItems: "アクションアイテムは見つかりませんでした",
    keywordsCompletedToast: "キーワード抽出が完了しました",
    actionItemsCompletedToast: "アクションアイテム抽出が完了しました",
    titleGeneratedToast: "タイトルが生成されました",
    extractingActionItems: "アクションアイテムを抽出中...",
    titleSuggestion: "タイトル候補",
    applyTitle: "適用",
    generateKeywords: "キーワードを抽出",
    generateActionItems: "アクションアイテムを抽出",
